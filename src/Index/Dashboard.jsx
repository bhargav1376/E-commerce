    ...
    if (modalKey === 'fresh') {
      ...
      return (
        <>
          <div style={{display:'flex', gap:16, justifyContent:'center', marginBottom:18, flexWrap:'wrap'}}>
            {freshProducts.map(p => (
              <div key={p.id} style={{textAlign:'center'}}>
                <img src={p.img} alt={p.name} style={{width:70, height:70, objectFit:'cover', borderRadius:10, marginBottom:6}} />
          ...
          <div style={{fontSize:15, color:'#444'}}>Experience the difference of farm-to-table freshness in every order!</div>
        </>
      );
    }
    if (modalKey === 'easy') {
      // Show shopping-related images and text
      const easyProduct = allProducts.find(p => p.category === 'Home');
      return (
        <>
          <div style={{display:'flex', justifyContent:'center', marginBottom:18}}>
            {easyProduct && <img src={easyProduct.img} alt={easyProduct.name} style={{width:90, height:90, objectFit:'cover', borderRadius:10}} />}
          </div>
          <div style={{fontSize:16, color:'#319795', marginBottom:10}}>
          ...
          <div style={{fontSize:15, color:'#444'}}>Shop from anywhere, anytime, with just a few clicks!</div>
        </>
      );
    }
    if (modalKey === 'deals') {
      ...
      return (
        <>
          ...
          <div style={{fontSize:15, color:'#444'}}>Check back often for new offers and limited-time savings!</div>
        </>
      );
    }
    if (modalKey === 'support') {
      ...
      return (
        <>
          ...
          <div style={{fontSize:15, color:'#444'}}>Reach out anytime—help is just a click away!</div>
        </>
      );
    }
    return null;
          ...
          <div className="dashboard-page-content">
            ...
            >
              ...
              <div className="slide-img-overlay-wrap">
                <img src={slides[slideIdx].img} alt={slides[slideIdx].title} className="slide-img new-top-slide-img" />
